...
### {}
```{r}
renderPlot(active_ratio_donut_graph(world, input$con_a))
```
###  {}
```{r}
renderPlot(active_ratio_donut_graph(world, input$con_b))
```
### {}
```{r}
renderPlot(active_ratio_donut_graph(world, input$con_c))
```
### {}  
```{r}
renderPlot(active_ratio_donut_graph(world, input$con_d))
```
...
###  {}
```{r}
renderPlot(effectiveness_of_response_graph(n_cases, input$con_b))
```
### {}
```{r}
renderPlot(effectiveness_of_response_graph(n_cases, input$con_c))
```
### {}
```{r}
renderPlot(effectiveness_of_response_graph(n_cases, input$con_d))
```
